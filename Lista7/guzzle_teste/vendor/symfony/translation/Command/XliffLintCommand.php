...
You can validates XLIFF contents passed from STDIN:
  ...
  <info>cat filename | App %command.full_name%</info>

You can also validate the syntax of a file:

  <info>App %command.full_name% filename</info>

Or of a whole directory:

  <info>App %command.full_name% dirname</info>
  <info>App %command.full_name% dirname --format=json</info>
